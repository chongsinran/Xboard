    ...
    private function getConfigMappings(): array
    {
        return [
            'invite' => [
                ...
                'invite_register_reward_enable' => (bool) admin_setting('invite_register_reward_enable', 0),
                'invite_register_referee_transfer_gb' => (float) admin_setting('invite_register_referee_transfer_gb', 0),
                'invite_register_referee_hours' => (float) admin_setting('invite_register_referee_hours', 0),
                'invite_register_referrer_transfer_gb' => (float) admin_setting('invite_register_referrer_transfer_gb', 0),
                'invite_register_referrer_hours' => (float) admin_setting('invite_register_referrer_hours', 0),
                'invite_level_a_enable' => (bool) admin_setting('invite_level_a_enable', 1),
                'invite_level_a_reward_transfer_gb' => (float) admin_setting('invite_level_a_reward_transfer_gb', 1),
                'invite_level_a_reward_hours' => (float) admin_setting('invite_level_a_reward_hours', 24),
                'invite_level_b_enable' => (bool) admin_setting('invite_level_b_enable', 1),
                'invite_level_b_valid_target' => (int) admin_setting('invite_level_b_valid_target', 10),
                'invite_level_b_paid_target' => (int) admin_setting('invite_level_b_paid_target', 1),
                'invite_level_b_reward_type' => admin_setting('invite_level_b_reward_type', 'months'),
                'invite_level_b_reward_value' => (int) admin_setting('invite_level_b_reward_value', 1),
                'invite_level_c_enable' => (bool) admin_setting('invite_level_c_enable', 1),
                'invite_level_c_valid_target' => (int) admin_setting('invite_level_c_valid_target', 50),
                'invite_level_c_paid_target' => (int) admin_setting('invite_level_c_paid_target', 10),
                'invite_level_c_reward_type' => admin_setting('invite_level_c_reward_type', 'years'),
                'invite_level_c_reward_value' => (int) admin_setting('invite_level_c_reward_value', 1),
                'invite_level_d_enable' => (bool) admin_setting('invite_level_d_enable', 1),
                'invite_level_d_valid_target' => (int) admin_setting('invite_level_d_valid_target', 100),
                'invite_level_d_paid_target' => (int) admin_setting('invite_level_d_paid_target', 30),
                'invite_level_d_reward_type' => admin_setting('invite_level_d_reward_type', 'lifetime'),
                'invite_level_d_reward_value' => (int) admin_setting('invite_level_d_reward_value', 1),
            ...
            'subscribe' => [
                ...
                'free_node_subscription_url' => admin_setting('free_node_subscription_url', ''),
            ],
            'frontend' => [
