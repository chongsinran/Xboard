...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'invite_never_expire' => '',
        'invite_register_reward_enable' => 'boolean',
        'invite_register_referee_transfer_gb' => 'nullable|numeric|min:0',
        'invite_register_referee_hours' => 'nullable|numeric|min:0',
        'invite_register_referrer_transfer_gb' => 'nullable|numeric|min:0',
        'invite_register_referrer_hours' => 'nullable|numeric|min:0',
        'invite_level_a_enable' => 'boolean',
        'invite_level_a_reward_transfer_gb' => 'nullable|numeric|min:0',
        'invite_level_a_reward_hours' => 'nullable|numeric|min:0',
        'invite_level_b_enable' => 'boolean',
        'invite_level_b_valid_target' => 'nullable|integer|min:0',
        'invite_level_b_paid_target' => 'nullable|integer|min:0',
        'invite_level_b_reward_type' => 'nullable|in:hours,days,months,years,lifetime',
        'invite_level_b_reward_value' => 'nullable|integer|min:0',
        'invite_level_c_enable' => 'boolean',
        'invite_level_c_valid_target' => 'nullable|integer|min:0',
        'invite_level_c_paid_target' => 'nullable|integer|min:0',
        'invite_level_c_reward_type' => 'nullable|in:hours,days,months,years,lifetime',
        'invite_level_c_reward_value' => 'nullable|integer|min:0',
        'invite_level_d_enable' => 'boolean',
        'invite_level_d_valid_target' => 'nullable|integer|min:0',
        'invite_level_d_paid_target' => 'nullable|integer|min:0',
        'invite_level_d_reward_type' => 'nullable|in:hours,days,months,years,lifetime',
        'invite_level_d_reward_value' => 'nullable|integer|min:0',
